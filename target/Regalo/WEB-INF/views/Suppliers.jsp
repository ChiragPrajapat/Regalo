			...
			<tbody>
				<c:forEach items="${lists}" var="supplier">
					...
					<tr>
						...
						<td>	<sec:authorize access="hasRole('ROLE_ADMIN')"><a href="${pageContext.request.contextPath}/supedit/${supplier.supplier_id} ">Edit</a></sec:authorize><sec:authorize access="hasRole('ROLE_ADMIN')">|<a href="${pageContext.request.contextPath}/supdelete/${supplier.supplier_id}">Delete</a></sec:authorize></td>
