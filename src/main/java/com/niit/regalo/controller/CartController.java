...
public class CartController {
	...
	public ModelAndView addToCart(@ModelAttribute Cart c,@RequestParam("product_id")int productId)
	{
		System.out.println("Adding to cart");
		c.setProductId(productId);
		
 		cartDAO.addToCart(c);
 	 	List cartList = cartDAO.Cartlist();
	...
	public String collectBilling(@RequestParam("cartId") int cartId, @ModelAttribute("cart") Cart c)
	{
