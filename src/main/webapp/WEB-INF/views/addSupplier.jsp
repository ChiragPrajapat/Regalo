	...
	<form:form method="post" commandName="addsupplier"
		...
		<table>
           ...
           <td><form:input path="supplier_id" value="${supplier.supplier_id}" /></td>
			...
			<tr>
			<tr>
				<td><form:label path="supplier_password">
						<spring:message text="Password" />
					</form:label></td>
				<td><form:input path="supplier_password" /></td>
				<td><form:errors path="supplier_password" cssClass="error" /></td>
			</tr>
			...
			<tr>
				...
				<td><td><form:input path="supplier_email" /></td>
