	...
	<form:form  method="post" commandName="addproduct">
		<table>
			...
			<tr>
				...
				<td><form:input path="product_id" size="8" /> <form:hidden
						path="product_id" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><form:input path="product_supplier" /> <form:hidden
			...
			<tr>
				...
				<td><form:input path="product_description" /> <form:hidden
			...
			<tr>
				...
				<td><form:input path="product_price" /> <form:hidden
						path="product_price" /></td>
			</tr>
			<tr>
				<td colspan="2"><c:if test="${!empty product.product_name}">
